import { Activity, ArrowDown, ArrowUp, Cpu, HeartPulse, Newspaper, Radar, ShieldCheck, Sparkles, TrendingUp, UsersRound, Zap } from 'lucide-react';
...
import { InsightMeter } from './insights/InsightPageShared.jsx';
import OptionsInsightsPage from './insights/OptionsInsightsPage.jsx';
import SentimentInsightsPage from './insights/SentimentInsightsPage.jsx';
import SignalsInsightsPage from './insights/SignalsInsightsPage.jsx';
            ...
            <div className="insight-card-head">
              ...
              <div className="time-tabs">
                {['1M', '3M', '6M', '1Y'].map((range) => (
                  <button
                    className={trendRange.isSelected(range) ? 'active' : ''}
                    key={range}
                    onClick={() => trendRange.select(range)}
                    type="button"
                  >
                    {range}
                  </button>
