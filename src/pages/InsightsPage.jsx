...
import { getInsightsData, getOptionsInsightsData, getSentimentInsightsData, getTickerStrip } from '../data/mock/selectors';
...
function toneClass(tone) {
  return tone === 'Negative' ? 'red' : tone === 'Positive' ? 'green' : 'neutral';
}
