import { Bookmark, CheckCircle2, ChevronDown, Download, Eye, GitCompareArrows, Play, Plus, Save, Search, ShieldCheck, X } from 'lucide-react';
...
import { getBacktestCompareData, getBacktestData, getTickerStrip } from '../data/mock/selectors';
...
function BacktestComparePage({ activePage, activeSidebarItem, onNavigate, onSidebarSelect }) {
  const { pendingAction, runAction } = useAppAction();
