...
import { Activity, AlertTriangle, BarChart3, Boxes, Check, CircleDollarSign, Download, Eye, PieChart, Play, Save, ShieldCheck, SlidersHorizontal, Target, TrendingUp, Undo2, Zap } from 'lucide-react';
...
import { getAllocationAssetData, getAllocationRebalanceRows, getAllocationRebalanceTradeRows, getAllocationRegionRows, getAllocationRiskData, getAllocationRows, getAllocationSectorRows, getAllocationTargetGroups, getAllocationTrendMonths, getTickerStrip } from '../data/mock/selectors';
...
function AllocationAssetsPage({ activePage, activeSidebarItem, onNavigate, onSidebarSelect }) {
  const { pendingAction, runAction } = useAppAction();
...
function AllocationRiskPage({ activePage, activeSidebarItem, onNavigate, onSidebarSelect }) {
  const { pendingAction, runAction } = useAppAction();
