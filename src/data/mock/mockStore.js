    ...
    sources: [
      {
        ...
        scope: ['Positions', 'Trades', 'Cash', 'Tax lots'],
        owner: 'Sarah Kim',
      },
      {
        id: 'market-data',
        ...
        cadence: 'Real-time',
        scope: ['Quotes', 'Fundamentals', 'Corporate actions'],
        owner: 'Ops Desk',
      },
      {
        id: 'csv-import',
        name: 'CSV Import Inbox',
        type: 'Import',
        ...
        health: 76,
        enabled: true,
        lastSync: 'Yesterday 18:10',
        cadence: 'Manual',
        scope: ['Trades', 'Dividends', 'Transfers'],
        owner: 'Ops Desk',
      },
      {
        id: 'calendar',
        ...
        type: 'Reference',
        provider: 'NYSE + KRX',
        account: 'Public calendars',
        status: 'Connected',
        health: 89,
        enabled: true,
        lastSync: 'Today 00:05',
        cadence: 'Daily',
        scope: ['Holidays', 'Trading sessions', 'Settlement dates'],
        owner: 'Risk Team',
      },
    ],
    importQueue: [
      { id: 'imp-001', file: 'fills-may-2026.csv', type: 'Trades', rows: 184, status: 'Mapped', received: 'Today 09:20', issues: 0 },
      { id: 'imp-002', file: 'dividends-q2.csv', type: 'Dividends', rows: 38, status: 'Review', received: 'Yesterday 18:10', issues: 3 },
      { id: 'imp-003', file: 'tax-lots-broker.csv', type: 'Tax Lots', rows: 412, status: 'Imported', received: 'May 14, 2026', issues: 0 },
    ],
    rules: {
      duplicateHandling: 'Flag for review',
      importMode: 'Stage before posting',
      priceSource: 'Market Data Feed',
      timezone: 'Asia/Seoul',
    },
  },
